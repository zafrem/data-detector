...
class TestBankAccountOverlap:
    ...
    def test_daegu_bank_not_business_reg(self, engine):
        ...
        for account in test_cases:
            ...
            assert len(biz_matches) == 0, f"{account} should NOT match business registration (has extra digit)"
    ...
    def test_jeonbuk_bank_not_business_reg(self, engine):
        ...
        for account in test_cases:
            ...
            bank_matches = [m for m in matches if m.ns_id in ['kr/bank_account_07', 'kr/bank_account_12']]
    ...
    def test_jeju_bank_vs_driver_license(self, engine):
        """Jeju Bank and Driver License have same format - should be distinguished by priority/context."""
